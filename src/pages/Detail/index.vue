		...
		<section class="con">
			...
			<div class="mainCon">
				...
				<div class="previewWrap">
					<!--放大镜效果-->
					<!-- skuInfo.skuImageList在服务器请求回来之前是没有数据的，因此还需要给一个空数组 -->
				...
				<div class="InfoWrap">
					...
					<div class="choose">
						<div class="chooseArea">
							...
							<dl v-for="(attr) in  spuSaleAttrList" :key="attr.attrId">
						...
						<div class="cartWrap">
							...
							<div class="add">
								<!-- 这里加入购物车的操作，进行路由跳转之前，发送请求把购买的产品信息通过请求通知服务器，
								服务器进行相应的存储-->
...
export default {
	...
	methods: {
		...
		async addShopCar() {
			...
			//3.失败，给用户提示
			// 调用仓库中的addOrUpdateShopCart函数，这个函数前面加上async，返回的一定是一个Promise
			try {
